  ...
  <nav className="bg-gray-800 border-b border-black-800">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:block">
            <div className="flex items-baseline ml-10 space-x-4">
              <Link href="/">
                <div className="px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700">
                  Home
                </div>
              </Link>
    ...
    <div className="md:hidden">
      <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
        <Link href="/">
          <div className="block px-3 py-2 text-base font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700">
            Home
          </div>
        </Link>
        <Link href="/create-nft">
